...
public class ChiUpdateDialog {
    ...
    public ChiUpdateDialog(final Context context, KhoanChiFragment fragment, Chi ...Chi) {
        mViewModel = fragment.getViewModel();
        mLayoutInflater = LayoutInflater.from(context);
        View view = mLayoutInflater.inflate(R.layout.dialog_update_chi,null);
                ...
                .setPositiveButton("Lưu", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (mEditMode){
                            ...
                            Toast.makeText(context, "Khoản Chi đã được cập nhật", Toast.LENGTH_SHORT).show();
                        }else{
                            mViewModel.insert(lt);
                            Toast.makeText(context, "Khoản Chi đã được thêm", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
